            ...
            <div className="bg-white rounded-xl p-8 shadow-md">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@example.com" className="text-gray-700 hover:text-portfolio-purple">namanladha2004@gmail.com</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+1234567890" className="text-gray-700 hover:text-portfolio-purple">+91 7080814370</a>
                  </div>
                </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex gap-4">
                  {['github', 'linkedin', 'twitter', 'dribbble'].map(social => <a key={social} href="#" className="w-10 h-10 rounded-full bg-portfolio-purple/10 flex items-center justify-center text-portfolio-purple hover:bg-portfolio-purple hover:text-white transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={18} height={18}>
                        {social === 'github' && <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" />}
                        {social === 'linkedin' && <>
